...
INDEXER_ENV_VARS="DATABASE_SCHEMA=$DATABASE_SCHEMA,PONDER_RPC_URL_1=$PONDER_RPC_URL_1,NODE_ENV=production,DB_USER=$DB_USER,DB_NAME=$DB_NAME,CLOUD_SQL_INSTANCE=$CLOUD_SQL_INSTANCE"
