...
export function handleAccountPositionCleared(
  ...
  // - contract.getVaultPosition(...)
  // - contract.getWithdrawRequestManager(...)
  // - contract.isLendingRouter(...)
  // - contract.lendingRouters(...)
  // - contract.pauseAdmin(...)
  // - contract.pendingPauseAdmin(...)
  // - contract.pendingUpgradeAdmin(...)
  // - contract.upgradeAdmin(...)
  // - contract.whitelistedVaults(...)
  // - contract.withdrawRequestManagers(...)
}
