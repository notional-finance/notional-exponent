...
contract MidasUSDOracle is AbstractCustomOracle {
    ...
    IMidasVault public immutable midasVault;
    ...
    {
        int256 mTokenRate = IMidasDataFeed(midasVault.mTokenDataFeed()).getDataInBase18().toInt();
        ...
        int256 usdcToUSD;
        (roundId, usdcToUSD, startedAt, updatedAt, answeredInRound) = usdcToUSDOracle.latestRoundData();
        require(usdcToUSD > 0, "Chainlink Rate Error");
        answer = (mTokenRate * usdcToUSD) / usdcToUSDDecimals;
    }
}
