...
import {BaseWithdrawRequestManager} from "./WithdrawRequest.sol";
import {IERC20} from "@openzeppelin/contracts/token/ERC20/IERC20.sol";

contract EtherFiWithdrawRequestManager is BaseWithdrawRequestManager {

    constructor(address _owner) BaseWithdrawRequestManager(_owner, address(0), address(weETH)) { }
