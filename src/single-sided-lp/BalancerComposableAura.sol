...
import {BalancerAuraPoolMixin} from "./BalancerAuraPoolMixin.sol";
import {IERC20} from "@openzeppelin/contracts/token/ERC20/IERC20.sol";
import {IBalancerVault} from "../interfaces/Balancer/IBalancerVault.sol";
import {IComposablePool} from "../interfaces/Balancer/IBalancerPool.sol";

contract BalancerComposableAura is BalancerAuraPoolMixin {
    ...
    ) BalancerAuraPoolMixin(_owner, _asset, _yieldToken, _feeRate, _irm, _lltv, balancerPoolId, rewardPool, whitelistedReward) {
    ...
    function _totalPoolSupply() internal view override returns (uint256) {
        return IComposablePool(address(yieldToken)).getActualSupply();
    }
}